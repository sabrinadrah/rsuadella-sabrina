    ...
    <section id="reservasi" class="reservasi">
        <div class="container">
            ...
            <div class="progressbar_form">
                ...
                <div class="progress-step" data-title="Cari Dokter atau Spesialis" ></div>
                <div class="progress-step progress-step-active" data-title="Pilih Jadwal"></div>
            ...
            <div class="box">
                <div class="d-flex justify-content-center">
                    ...
                    <form method="POST" class="form-reservasi">
                        ...
                        <!-- Steps 2 -->
                        <div class="form-step">
                            <div class="reservasi__back"><a href="{{ route('reservasi.cari') }}" class="btn btn-color"><i class="bi bi-arrow-left"></i></a> Pilih Jadwal</div>
                            <div class="box__dokter_2 mt-4">
                                <div class="row">
                                    <div class="col-md-3 col-sm-12">
                                        <div class="box">
                                            <div class="text-center">
                                                <img src="{{url('assets/images/dokter')}}/{{ $dokter->foto }}" class="img-fluid mx-auto">
                                            </div>
                                            <div class="my-2 dokter__name"><strong>{{ $dokter->nama }}, {{ $dokter->gelar }}</strong></div>
                                            <div class="mb-2">
                                            ...
                                            <div class="mb-2"><i class="bi bi-geo-alt"></i>   
                                                RS Adella Slawi
                                            </div>
                                            <button type="button" class="btn btn-color w-100" data-bs-toggle="modal" data-bs-target="#profilModal-{{ $dokter->id }}">Lihat Profil</button>
                                        </div>
                                    </div>
                                    <div class="col-md-9 col-sm-12">
                                        <div class="pilih mb-2">Pilih Tanggal</div>
                                        <div id="datepicker" class="datepicker"></div>
                                        <!-- Input tersembunyi untuk menyimpan tanggal yang dipilih -->
                                        <input type="hidden" id="selectedDate" name="tanggal">

                                        <div class="pilih mt-2">Pilih Jam</div>
                                        <div class="jam-praktek">
                                            <div class="row">
                                                <div class="col-md-4 col-sm-6 mb-2">
                                                    <label class="btn jam-button w-100">
                                                        <input type="radio" name="jam_praktek" value="1"> 08.00 - 11.00

                                                        <input type="hidden" name="start" value="08:00">
                                                        <input type="hidden" name="end" value="11:00">
                                                    </label>
                                                    
                                                </div>
                                                <div class="col-md-4 col-sm-6 mb-2">
                                                    <label class="btn jam-button w-100">
                                                        <input type="radio" name="jam_praktek" value="2"> 13.00 - 15.00

                                                        <input type="hidden" name="start" value="13:00">
                                                        <input type="hidden" name="end" value="15:00">
                                                    </label>                                      
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="mt-3">
                                    <a href="#" id="lanjutButton" class="btn btn-next btn-color w-100 jam-disabled" style="font-weight: 700; font-size: 20px">
                                        Lanjut
                                    </a>
                                </div>
                            </div>
                        ...
                        <!-- Steps 3 -->
                        <div class="form-step">
                            <div class="reservasi__back"><a href="#" class="btn btn-prev btn-color"><i class="bi bi-arrow-left"></i></a> Jenis Pasien</div>
                            <div class="box__dokter_3">
                                <div class="section-title mt-4">
                                    <h2>Jenis Pasien</h2>
                                    <p>Anda dapat memilih untuk opsi “Pasien Lama” jika anda sudah pernah menerima perawatan di RS Adella sebelumnya dan sudah memiliki nomor rekam medis atau Anda dapat memilih untuk opsi “Pasien Baru” jika Anda belum pernah berobat di RS Adella.</p>
                                </div>

                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <a href="#" class="btn btn-next btn-jenis_pasien w-100" onclick="showFormStep('lama')">Pasien Lama</a>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <a href="#" class="btn btn-next btn-jenis_pasien w-100" onclick="showFormStep('baru')">Pasien Baru</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Steps 4 - Pasien Lama -->
                        <div class="form-step">
                            <div class="reservasi__back"><a href="#" class="btn btn-prev btn-color"><i class="bi bi-arrow-left"></i></a> Input Data</div>
                        
                            <div class="box__dokter_4 form-step-lama" style="display: none;">

                                <div class="section-title mt-4">
                                    <h2>Pasien Lama</h2>
                                    <p>Anda dapat mengisi data untuk reservasi sebagai pasien lama.</p>
                                </div>

                                <div class="form-pasien">
                                    <div class="form-group">
                                        <label class="control-label required" for="niks">No RM/NIK/BPJS/KIS/JKN</label>
                                        <div>
                                            <input id="niks" name="niks" type="text" class="form-control" placeholder="Isi dengan No RM/NIK/BPJS/KIS/JKN Anda..">
                                            @error('niks')
                                    ...
                                    <div class="form-group">
                                        <label class="control-label required" for="tanggal">Tanggal Lahir</label>
                                        <div>
                                            <input id="ttls" name="ttls" type="date" class="form-control">
                                            @error('ttls')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="penjamins">Penjamin</label>
                                        <div>
                                            <select id="penjamins" name="penjamins" class="form-control">
                                                <option value="" selected>- Pilih -</option>
                                                <option value="Manulife">Manulife</option>
                                                <option value="Garda Medika">Garda Medika</option>
                                                <option value="Bringin Life">Bringin Life</option>
                                    ...
                                    <div class="mt-4">
                                        <button type="submit" class="btn btn-antrian btn-color w-100" formaction="{{ route('reservasi.old', ['id' => $dokter->id]) }}">Reservasi</button>
                                    </div>
                                </div>
                            </div>

                            <div class="box__dokter_4 form-step-baru" style="display: none;">
                                <div class="section-title mt-4">
                                    <h2>Pasien Baru</h2>
                                    <p>Anda dapat mengisi data untuk reservasi sebagai pasien baru.</p>
                                </div>

                                <div class="form-step-pasienBaru form-stepBaru-active">
                                    <div class="form-group">
                                        <label class="control-label required" for="nik">NIK</label>
                                        <div>
                                            <input id="nik" name="nik" type="text" class="form-control" placeholder="Isi dengan NIK pasien..">
                                            @error('nik')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label required" for="name">Nama Lengkap</label>
                                        <div>
                                            <input id="nama" name="nama" type="text" class="form-control" placeholder="Isi dengan nama panjang pasien..">
                                            @error('nik')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label required" for="tanggal">Tanggal Lahir</label>
                                        <div>
                                            <input id="ttl" name="ttl" type="date" class="form-control">
                                            @error('ttl')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mt-4 text-end">
                                        <a href="#" class="btn btn-next btn-inputPasien btn-color" style="width: 50%;">Lanjut <i class="bi bi-arrow-right"></i></a>
                                    </div>
                                </div>
                                <div class="form-step-pasienBaru">
                                    <div class="form-group">
                                        <label class="control-label required" for="ibu">Ibu Kandung Pasien</label>
                                        <div>
                                            <input id="ibu" name="ibu" type="text" class="form-control" placeholder="Nama ibu kandung pasien..">
                                            @error('ibu')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label required" for="address">Alamat</label>
                                        <div>
                                            <textarea id="alamat" name="alamat" rows="3" class="form-control" placeholder="Detail alamat pasien.."></textarea>
                                            @error('alamat')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-6">
                                            <a href="#" class="btn btn-prev btn-inputPasien btn-color w-100"><i class="bi bi-arrow-left"></i> Kembali</a>
                                        </div>
                                        <div class="col-6">
                                            <a href="#" class="btn btn-next btn-inputPasien btn-color w-100">Lanjut <i class="bi bi-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-step-pasienBaru">
                                    <div class="form-group">
                                        <label class="control-label" for="bpjs">No BPJS</label>
                                        <div>
                                            <input id="no_bpjs" name="no_bpjs" type="text" class="form-control" placeholder="Nomor BPJS pasien..">
                                            @error('no_bpjs')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            <label class="control-label required" for="gender">Jenis Kelamin</label>
                                            <div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label class="control-label required" for="blood">Golongan Darah</label>
                                            <div>
                                                <select id="goldar" name="goldar" class="form-control">
                                                    <option value="" selected>- Pilih -</option>
                                                    <option>O</option>
                                                    <option>A</option>
                                                    <option>B</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            <label class="control-label required" for="religion">Agama</label>
                                            <div>
                                ...
                                <div class="form-step-pasienBaru">
                                    <div class="form-group">
                                        <label class="control-label required" for="academic">Pendidikan</label>
                                        <div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label required" for="work">Pekerjaan</label>
                                        <div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label required" for="penjamin">Penjamin</label>
                                        <div>
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-6">
                                            <button type="submit" class="btn btn-inputPasien btn-color w-100" formaction="{{ route('reservasi.store', ['id' => $dokter->id]) }}">Pesan <i class="bi bi-arrow-right"></i></button>
                                            {{-- <button type="button" class="btn btn-inputPasien btn-color w-100" data-bs-toggle="modal" data-bs-target="#reservasiModal">Pesan <i class="bi bi-arrow-right"></i></button> --}}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- MODAL Profil Dokter -->
                        <div class="modal fade modalDokter" id="profilModal-{{ $dokter->id }}" tabindex="-1" role="dialog" aria-labelledby="profilModalTitle" aria-hidden="true">
...
<script>
    ...
    function selectDate(date) {
      ...
      // Mengonversi tanggal menjadi string dengan format "YYYY-MM-DD"
      var formattedDate = date.split(' ')[2] + '-' + getMonthNumber(date.split(' ')[1]) + '-' + date.split(' ')[3];
    ...
    function getMonthNumber(monthName) {
      ...
      return ('0' + (monthNames.indexOf(monthName) + 1)).slice(-2);
    }

    // Mendapatkan tanggal hari ini
    var today = new Date();
    // Mendapatkan tanggal sebelum hari ini
    ...
    var defaultConfig = {
      ...
      prevButton: '<i class="bi bi-chevron-double-left btn-color btn-date"></i>',
      nextButton: '<i class="bi bi-chevron-double-right btn-color btn-date"></i>',
      min: minDate
    };
    var calendar = $('#datepicker').calendar(defaultConfig);

    // Button lanjut setelah pilih jadwal
    var jamButtons = document.querySelectorAll('.jam-button');
    var lanjutButton = document.getElementById('lanjutButton');

    jamButtons.forEach(function(button) {
        button.addEventListener('click', function(event) {
            event.preventDefault();

            jamButtons.forEach(function(btn) {
                btn.classList.remove('selected');
            });
            this.classList.add('selected');
        
            var selectedJam = document.querySelector('.jam-button.selected');
            if (selectedJam) {
                lanjutButton.removeAttribute('disabled');
                lanjutButton.classList.remove('jam-disabled');
            } else {
                lanjutButton.setAttribute('disabled', 'disabled');
                lanjutButton.classList.add('jam-disabled');
            }
        });
    });

    // Form Lama dan Form Baru
    function showFormStep(type) {
        if (type === 'lama') {
            // Menampilkan form-step untuk Pasien Lama
            document.querySelector('.form-step-lama').style.display = 'block';
            document.querySelector('.form-step-baru').style.display = 'none';
        } else if (type === 'baru') {
            // Menampilkan form-step untuk Pasien Baru
            document.querySelector('.form-step-lama').style.display = 'none';
            document.querySelector('.form-step-baru').style.display = 'block';
        }
    }
